                                ...
                                foreach (var peer in peers)
                                {
                                    ...
                                    if (wrkgrp.MpCategory == MpGroupType.Wg1 && member.StudentId == peer.StudentId)
                                    {
                                        var comment = new SpComment
                                        {
                                            ...
                                            MpCommentType =
                                                (member.StudentId%2 == 0) ? MpCommentType.Anon : MpCommentType.Signed,
                                            ...
                                            CommentText =
                                                (peer.StudentId %2 == 0)
                                                    ...
                                                    : (peer.StudentId%5 == 0)
                                                        ...
                                                        : $"<h4>What's up {peer.StudentId}, what were you thinking when you r...habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo."
