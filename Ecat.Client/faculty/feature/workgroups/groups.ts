...
export default class EcInstructorGroups {
    static controllerId = 'app.faculty.features.groups';
    ...
    courses: ecat.entity.ICrseStudInGroup[] = [];
    selectedCourse: ecat.entity.ICourse;
    selectedGroup: ecat.entity.IWorkGroup;
    //selectedGroup: ecat.entity.IWorkGroup;
    selectedStudent: ecat.entity.ICrseStudInGroup;
    selectedComment: ecat.entity.ISpComment;
    publishStatus = {
    ...
    groupCapstoneData: any = {};
    capstoneStudents: ecat.entity.ICrseStudInGroup[] = [];
    groupTypes: string[] = [];
    strats: any = {};
    ...
    changeCourse(selectedCourse: ecat.entity.ICrseStudInGroup): void {
        //this.selectedCourse = selectedCourse.courseEnrollment;
        this.dCtx.faculty.activeCourseId = this.selectedCourse.id;
    }

    selectGroup(selected: ecat.entity.IWorkGroup, type: string): void {
    ...
    setUpStrats(): void {
        this.selectedGroup.groupMembers.forEach((gm: ecat.entity.ICrseStudInGroup) => {
            this.dCtx.faculty.getFacStrat(gm.studentId);
        });
    }
    ...
    setUpCapstone(): void {
        ...
        function gotCapstoneData(retData: Array<ecat.entity.ICrseStudInGroup>): void {
    ...
    viewCapstoneStudentDetails(student: ecat.entity.ICrseStudInGroup): void {
    ...
    addComment(recipient: ecat.entity.ICrseStudInGroup): void {
    //    const self = this;
    ...
    editComment(recipient: ecat.entity.ICrseStudInGroup): void {
        //const self = this;
        //var comment = this.selectedGroup.facSpComments.filter(com => {
